...
<article class="formulario">
    ...
    <form name="form" method="post" action="Contatando.php">
        ...
        Deixe sua mensagem:<br><textarea rows="10" cols="30" name="mensagem"></textarea><br>
...
<article class="redes">
    ...
    <figure>
        <p><a href="http://facebook.com.br" target="_blank"><img src="../Imagens/facebook.png" width="25px" height="25px" alt="link_logo_facebook">Facebook/autocarnews</a></p>        
    </figure>
    <figure>
        <p><a href="http://twitter.com.br" target="_blank"><img src="../Imagens/twitter-logo.png" width="25px" height="25px" alt="link_logo_facebook">Twitter/autocarnews</a></p>
    </figure>
    <figure>
        <p><a href="https://www.linkedin.com/" target="_blank"><img src="../Imagens/linkedin.png" width="25px" height="25px" alt="link_logo_facebook">Linkedin/autocarnews</a></p>
    </figure>
    <figure>
        <p><a href="https://myspace.com/" target="_blank"><img src="../Imagens/myspace.png" width="25px" height="25px" alt="link_logo_facebook">MySpace/autocarnews</a></p>
    </figure>
    <figure>
        <p><a id="tumblr" href="https://www.tumblr.com" target="_blank"><img src="../Imagens/tumblr.png" width="27px" height="27px" alt="link_logo_facebook">Tumblr/autocarnews</a></p>
    </figure>
</article>
<footer>
